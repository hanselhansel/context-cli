...
@pytest.mark.asyncio
async def test_generate_batch_stub_raises():
    """The batch.py stub should raise NotImplementedError."""
    from aeo_cli.core.generate.batch import generate_batch as _batch_fn

    config = BatchGenerateConfig(urls=["https://example.com"])
    with pytest.raises(NotImplementedError, match="Stub"):
        await _batch_fn(config)
