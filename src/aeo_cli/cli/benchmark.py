...
from aeo_cli.core.models import BenchmarkConfig, BenchmarkReport
...
def register(app: typer.Typer) -> None:
    ...
    def benchmark(
        ...
        # Load prompts
        try:
            from aeo_cli.core.benchmark.loader import load_prompts
        except ImportError:
            console.print(
        ...
        # Estimate cost
        from aeo_cli.core.benchmark.cost import estimate_benchmark_cost, format_cost
