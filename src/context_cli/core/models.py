...
class ProductData(BaseModel):
    ...
    schema_org: dict = Field(default_factory=dict, description="Extracted Schema.org JSON-LD data")
    ...
    alt_texts: list[str] = Field(default_factory=list, description="Alt text for product images")
